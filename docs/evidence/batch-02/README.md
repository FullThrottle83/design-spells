...
[CI run 36228537619](https://github.com/FullThrottle83/design-spells/actions/runs/36228537619) passed **80 Python + 376 Chromium tests** and **350 Firefox/WebKit tests**, including all Batch 02 scenarios. The images in this folder are still Chromium captures; the CI result is not a claim that these are screenshots from the other engines.
